...
(cl:defmethod cl:initialize-instance :after ((m <Vector3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chapter7_tutorials-msg:<Vector3> is deprecated: use chapter7_tutorials-msg:Vector3 instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter7_tutorials-msg:x-val is deprecated.  Use chapter7_tutorials-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter7_tutorials-msg:y-val is deprecated.  Use chapter7_tutorials-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Vector3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter7_tutorials-msg:z-val is deprecated.  Use chapter7_tutorials-msg:z instead.")
  (z m))

...
(cl:defclass <Twist> (roslisp-msg-protocol:ros-message)
  ((linear
    :reader linear
    :initarg :linear
    :type chapter7_tutorials-msg:Vector3
    :initform (cl:make-instance 'chapter7_tutorials-msg:Vector3))
   (angular
    :reader angular
    :initarg :angular
    :type chapter7_tutorials-msg:Vector3
...
(cl:defmethod cl:initialize-instance :after ((m <Twist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chapter7_tutorials-msg:<Twist> is deprecated: use chapter7_tutorials-msg:Twist instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <Twist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter7_tutorials-msg:linear-val is deprecated.  Use chapter7_tutorials-msg:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <Twist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter7_tutorials-msg:angular-val is deprecated.  Use chapter7_tutorials-msg:angular instead.")
  (angular m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Twist>)))
  ...
  (cl:format cl:nil "# This expresses velocity in free space broken into it's linear and angular parts. ~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: chapter7_tutorials/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Twist)))
  "Returns full string definition for message of type 'Twist"
  (cl:format cl:nil "# This expresses velocity in free space broken into it's linear and angular parts. ~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: chapter7_tutorials/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
